...
- **API Version**: pinned in `build.gradle.kts` (currently `boss-plugin-api-1.0.88.jar`); the floor moves whenever the plugin uses a newer surface
...
- **bosseditor-compose-desktop**: bundled privately; 1.0.15 is required for multiline inline AI suggestions (and includes the LSP fixes introduced in 1.0.13)
