...
/**
 * Auto save toggle. The same setting the host offers under File in the menu bar - this is the
 * copy that works without a host new enough to render that item.
 */
@Composable
internal fun AutoSaveSettingsContent(
    enabled: Boolean,
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            Text(
                text = "Write changes to disk a moment after you stop typing, without Cmd+S.",
