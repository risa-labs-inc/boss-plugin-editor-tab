...
dependencies {
    ...
    // Plugin API - provides TabRegistry, TabInfo, EditorContentProvider, etc.
    compileOnly("com.risaboss:plugin-api-desktop:1.0.11")

    // Plugin Tab Code Editor - provides CodeEditorTabType and EditorTabInfo
    compileOnly("com.risaboss:plugin-tab-code-editor-desktop:1.0.0")
}
...
tasks.jar {
    ...
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Code Editor Tab Dynamic Plugin",
